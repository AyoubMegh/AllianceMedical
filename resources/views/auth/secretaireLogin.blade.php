...
@section('image')
<div class="col-lg-6 d-none d-lg-block bg-login-image-secretaire" style="margin-right: -75px;"></div>
@endsection
@section('slogan')
<h1 class="h4 text-gray-900 mb-4"><i>" Qui n'a santé n'a rien, mais par elle on a tout. "</i></h1>
@endsection
@section('form-login')
<center>
 <h6 class="font-weight-light "> Compte du Secretaire</h5>
<center>
