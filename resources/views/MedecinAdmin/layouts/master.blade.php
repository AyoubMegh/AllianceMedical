    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <a class="nav-link" href="{{url('/admin/statistiques')}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('/admin/ListePatients')}}">
                    <i class="fas fa-users"></i>
                    <span>Liste Patients</span>
                </a>
                <a class="nav-link collapsed" href="{{url('/admin/EtablireDossierPatient')}}">
                    <i class="fas fa-file-medical-alt"></i>
                    <span>Etablire Dossier Patient</span>
                </a>
                <a class="nav-link collapsed" href="{{url('/admin/PrendreRDV')}}">
            ...
            <div class="sidebar-heading">
             ...
             <!-- Nav Item - Pages Collapse Menu -->
             <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('/admin/EtablireOrdonnance')}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('/admin/VisualisationPatient')}}">
                    <i class="far fa-eye"></i>
                    <span>Visualisation Patient</span>
                </a>
                <a class="nav-link collapsed" href="{{url('/admin/VisualisationPrescription')}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMedecin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/admin/AjouterMedecin')}}">Ajouter</a>
                        <a class="collapse-item" href="{{url('/admin/ModifierMedecin')}}">Modifier</a>
                        <a class="collapse-item" href="{{url('/admin/SupprimerMedecin')}}">Supprimer</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseSecretaire" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/admin/AjouterSecretaire')}}">Ajouter</a>
                        <a class="collapse-item" href="{{url('/admin/ModifierSecretaire')}}">Modifier</a>
                        <a class="collapse-item" href="{{url('/admin/SupprimerSecretaire')}}">Supprimer</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Khmis Khenchla</span>
