...
<div class="container-fluid">
    <div class="container center-div">
        <center><h3>Certificat de Bonne Santé</h3></center>
        <div class="conteiner mt-4">
            <form action="{{route('medecin.certificatBonneSante')}}" method="post">
                {{ csrf_field() }}
    ...
    <div class="container center-div">
        <center><h5><u>Divers Certificat de Bonne Santé</u></h5></center>
                                        ...
                                        <div class="modal fade" id="lettre_{{$lettre->id_lettre}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content">
                                                ...
                                                <form action="{{route('medecin.majCertificatBS')}}" method="post">
                                                    {{csrf_field() }}
                                                    {{method_field('PUT')}}
