                    ...
                    <ul class="navbar-nav ml-auto" >
                        ...
                        <li class="nav-item dropdown no-arrow mx-1" >
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                @if(count(App\Notification::all()->where('id_med',Auth::user()->id_med))!=0)
                            ...
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown" id="show_notif">
                                <h6 class="dropdown-header">
                                    Notifications 
                                </h6>
                                @foreach(App\Notification::where('id_med',Auth::user()->id_med)->orderBy('created_at','DESC')->limit(3)->get() as $notif)
                                <a class="dropdown-item d-flex align-items-center" href="{{route('medecin.notifications')}}">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">{{$notif->titre}}</span>
                                    </div>
                                </a>
                                @endforeach
                                <a class="dropdown-item text-center small text-gray-500" href="{{route('medecin.notifications')}}">Voir tous les Notifications</a>
                            </div>
                        </li>
